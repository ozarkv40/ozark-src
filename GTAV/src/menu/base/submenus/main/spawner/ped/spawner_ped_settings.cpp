#include "spawner_ped_settings.h"
#include "menu/base/submenu_handler.h"
#include "../../spawner.h"

using namespace spawner::ped::settings::vars;

namespace spawner::ped::settings::vars {
	variables m_vars;
}

void spawner_ped_settings_menu::load() {
...
void spawner_ped_settings_menu::update() {}

void spawner_ped_settings_menu::update_once() {}

void spawner_ped_settings_menu::feature_update() {}

spawner_ped_settings_menu* g_instance;
spawner_ped_settings_menu* spawner_ped_settings_menu::get() {
	if (g_instance == nullptr) {
		g_instance = new spawner_ped_settings_menu();
		g_instance->load();
